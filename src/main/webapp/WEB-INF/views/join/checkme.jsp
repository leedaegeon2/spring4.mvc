<%@ page pageEncoding="UTF-8" %>
        ...
        <div class="mt25">
             ...
             <div class="mt25">
                 <h3>가입인증</h3>
                 <small class="text-muted">회원으로 가입하는 방법에는 2가지 방법이 있습니다. 아래에서 원하는 방법을 선택해주세요.입력하신 정보는 가입완료 전까지 본 사이트에 저장되지 않습니다.</small>
                 <hr>
              </div> 
                      ...
                      <div class="row">
                          <div class="col-12 text-center">
                            <button type="button" id="checkbtn"
                                    ...
                                    <i class="bi-check"> 확인하기</i></button>
