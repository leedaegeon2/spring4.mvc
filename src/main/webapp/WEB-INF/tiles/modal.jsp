        ...
        <div class="modal-content">
            ...
            <form id="loginfrm" name="loginfrm">
                <div class="form-group row text-danger">
                    <label for="userid"
                           class="col-form-label col-4 text-right" >아이디</label>
                    <input type="text" name="userid"
                           id="userid" class="form-control col-6 border-danger">
                </div>
                ...
                <div class="form-group row text-danger">
                    ...
                    <input type="password" name="passwd"
                           id="passwd" class="form-control col-6 border-danger">
                </div>
            ...
            <div class="modal-footer justify-content-center">
                ...
                <button type="button" id="findipbtn"
