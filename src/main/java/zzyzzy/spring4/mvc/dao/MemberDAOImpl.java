...
public class MemberDAOImpl implements MemberDAO {
    ...
    public int selectOneUserid(String uid) {
        ...
        return jdbcTemplate.queryForObject(
                selectOneUserid, params, Integer.class);
    }
   ...
   @Override
    ...
    public int insertMember(MemberVO mvo) {
        Object[] params = new Object[] { mvo.getUserid(), mvo.getPasswd(), mvo.getName(),
                mvo.getJumin1(), mvo.getJumin2(), mvo.getZipcode(), mvo.getAddr(), mvo.getEtcaddr(),
