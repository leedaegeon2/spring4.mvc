...
import zzyzzy.spring4.mvc.service.MemberService;
...
@Controller
    ...
    // joinme -> controller -> joinok (정보입력완료, captcha 체크ok)
    // joinme -> controller -> joinme (정보입력완료, captcha 체크no)
    ...
    public void fineZipcode(String dong, HttpServletResponse res) {

        try {
            // 응답결과를 JSON으로 설정하고 한글인코딩은 UTF-8로 MIME type지정
